        ...
        if ((result = UpdateGameInstallation(HDLGameList[GameIndex].PartName, GameSettings.FullTitle, GameSettings.CompatibilityModeFlags, HDLGameList[GameIndex].TRType, HDLGameList[GameIndex].TRMode, HDLGameList[GameIndex].DiscType)) >= 0) {
            ...
            InstallOSDResources_start:
                if ((result = InstallGameInstallationOSDResources(HDLGameList[GameIndex].PartName, &GameSettings, IconSource != ICON_SOURCE_DEFAULT ? &McSaveIconSys : NULL, IconSource != ICON_SOURCE_DEFAULT ? (IconSource == ICON_SOURCE_EXTERNAL ? ExternalIconSourcePath : SaveFolderPath) : NULL)) >= 0) {
                    ...
                    if (result >= 0)
                        DisplayInfoMessage(SYS_UI_MSG_GAME_UPDATE_COMPLETE);
                } else {
...
static struct UIMenuItem NetstatMenuItems[] = {
    ...
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_ADDRESS_TYPE},
    {MITEM_TAB},
    {MITEM_LABEL, NETSTAT_ID_ADDRESS_TYPE},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_MAC_ADDRESS},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_MAC_0, MITEM_FLAG_READONLY, MITEM_FORMAT_HEX, 2, 0, 0, 0, 0, 255},
    {MITEM_COLON},
    {MITEM_VALUE, NETSTAT_ID_MAC_1, MITEM_FLAG_READONLY, MITEM_FORMAT_HEX, 2, 0, 0, 0, 0, 255},
    {MITEM_COLON},
    {MITEM_VALUE, NETSTAT_ID_MAC_2, MITEM_FLAG_READONLY, MITEM_FORMAT_HEX, 2, 0, 0, 0, 0, 255},
    {MITEM_COLON},
    {MITEM_VALUE, NETSTAT_ID_MAC_3, MITEM_FLAG_READONLY, MITEM_FORMAT_HEX, 2, 0, 0, 0, 0, 255},
    {MITEM_COLON},
    {MITEM_VALUE, NETSTAT_ID_MAC_4, MITEM_FLAG_READONLY, MITEM_FORMAT_HEX, 2, 0, 0, 0, 0, 255},
    {MITEM_COLON},
    {MITEM_VALUE, NETSTAT_ID_MAC_5, MITEM_FLAG_READONLY, MITEM_FORMAT_HEX, 2, 0, 0, 0, 0, 255},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_IP_ADDRESS},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_IP_0, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_IP_1, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_IP_2, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_IP_3, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_NM_ADDRESS},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_NM_0, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_NM_1, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_NM_2, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_NM_3, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_GW_ADDRESS},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_GW_0, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_GW_1, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_GW_2, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, NETSTAT_ID_GW_3, MITEM_FLAG_READONLY, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_BREAK},

    {MITEM_BREAK},

    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_LINK_STATE},
    {MITEM_TAB},
    {MITEM_LABEL, NETSTAT_ID_LINK_STATE},
    {MITEM_BREAK},
    {MITEM_LABEL, NETSTAT_ID_LINK_MODE_LABEL, 0, 0, 0, 0, 0, SYS_UI_LBL_LINK_MODE},
    {MITEM_TAB, NETSTAT_ID_LINK_MODE_TAB},
    {MITEM_LABEL, NETSTAT_ID_LINK_MODE},
    {MITEM_BREAK},
    {MITEM_LABEL, NETSTAT_ID_LINK_FLOW_CONTROL_LABEL, 0, 0, 0, 0, 0, SYS_UI_LBL_FLOW_CONTROL},
    {MITEM_TAB, NETSTAT_ID_LINK_FLOW_CONTROL_TAB},
    {MITEM_LABEL, NETSTAT_ID_LINK_FLOW_CONTROL},
    {MITEM_BREAK},

    {MITEM_BREAK},

    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_DROPPED_TX_FRAMES},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_DROPPED_TX_FRAMES, MITEM_FLAG_READONLY},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_DROPPED_RX_FRAMES},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_DROPPED_RX_FRAMES, MITEM_FLAG_READONLY},
    {MITEM_BREAK},

    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_TX_LOSSCR},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_TX_LOSSCR, MITEM_FLAG_READONLY},
    {MITEM_TAB},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_RX_OVERRUN},
    {MITEM_TAB},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_RX_OVERRUN, MITEM_FLAG_READONLY},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_TX_EDEFER},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_TX_EDEFER, MITEM_FLAG_READONLY},
    {MITEM_TAB},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_RX_BADLEN},
    {MITEM_TAB},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_RX_BADLEN, MITEM_FLAG_READONLY},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_TX_COLLISON},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_TX_COLLISION, MITEM_FLAG_READONLY},
    {MITEM_TAB},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_RX_BADFCS},
    {MITEM_TAB},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_RX_BADFCS, MITEM_FLAG_READONLY},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_TX_UNDERRUN},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_TX_UNDERRUN, MITEM_FLAG_READONLY},
    {MITEM_TAB},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_RX_BADALIGN},
    {MITEM_TAB},
    {MITEM_VALUE, NETSTAT_ID_RX_BADALIGN, MITEM_FLAG_READONLY},
    {MITEM_BREAK},
...
static struct UIMenuItem RemoconMenuItems[] = {
    ...
    {MITEM_STRING, REMOCON_SCREEN_ID_MESSAGE, MITEM_FLAG_READONLY},
    {MITEM_BREAK},
    {MITEM_BREAK},
...
static struct UIMenuItem OptionsMenuItems[] = {
    ...
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_SORT_TITLES},
    {MITEM_TAB},
    {MITEM_TOGGLE, OPTIONS_ID_SORT_TITLES},
    {MITEM_BREAK},
    ...
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_USE_DHCP},
    {MITEM_TAB},
    {MITEM_TOGGLE, OPTIONS_ID_NETWORK_DHCP},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_IP_ADDRESS},
    {MITEM_TAB},
    {MITEM_VALUE, OPTIONS_ID_IP_0, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_IP_1, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_IP_2, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_IP_3, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_NM_ADDRESS},
    {MITEM_TAB},
    {MITEM_VALUE, OPTIONS_ID_NM_0, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_NM_1, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_NM_2, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_NM_3, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_GW_ADDRESS},
    {MITEM_TAB},
    {MITEM_VALUE, OPTIONS_ID_GW_0, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_GW_1, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_GW_2, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_DOT},
    {MITEM_VALUE, OPTIONS_ID_GW_3, 0, MITEM_FORMAT_UDEC, 3, 0, 0, 0, 0, 255},
    {MITEM_BREAK},

    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_ADVANCED_SETTINGS},
    {MITEM_TAB},
    {MITEM_TOGGLE, OPTIONS_ID_ADVANCED_NETWORK},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_LINK_MODE},
    {MITEM_TAB},
    {MITEM_TAB},
    {MITEM_ENUM, OPTIONS_ID_LINK_MODE},
    {MITEM_BREAK},
    {MITEM_LABEL, 0, 0, 0, 0, 0, 0, SYS_UI_LBL_FLOW_CONTROL},
    {MITEM_TAB},
    {MITEM_TAB},
    {MITEM_TOGGLE, OPTIONS_ID_LINK_FLOW_CONTROL},
    {MITEM_BREAK},

    {MITEM_BREAK},

    {MITEM_BUTTON, OPTIONS_ID_OK, 0, 0, 16},
    {MITEM_BREAK},
    {MITEM_BREAK},
...
static int ShowOptions(void)
{
    ...
    while (1) {
        ...
        if (UIExecMenu(&OptionsMenu, -1, NULL, &OptionsMenuUpdate) == OPTIONS_ID_OK) { // User selected "OK"
    ...
    while (!done) {
        ...
        if (NumHDLGames > 0) {
            ...
            if (PadStatus_raw & PAD_UP) {
                ...
                if (GameListDisplayData.SelectedGameIndex > 0)
                    GameListDisplayData.SelectedGameIndex--;
            }
            if (PadStatus_raw & PAD_DOWN) {
                if (GameListDisplayData.SelectedGameIndex < NumHDLGames - 1)
                    GameListDisplayData.SelectedGameIndex++;
        ...
        if (PadStatus & CancelButton) {
            ...
            if (PadStatus & PAD_START) {
                ...
                if (ShowOptions() == 1) { // Refresh the list if there is a need to.
                    NumHDLGames = ReloadGameList(&HDLGameList, &GameListDisplayData);
                }
            }
    ...
    if ((result = InitGameCDVDInformation(ReadMode, DiscID, StartupFname, &DiscType, &SectorsInDiscLayer0, &SectorsInDiscLayer1)) >= 0) {
        ...
        RedisplayGameOptionScreen:
            ...
            RedisplayGameIconOptionScreen:
                ...
                DEBUG_PRINTF("User canceled game installation.\n");
        }
    } else {
        sceCdStop();
        sceCdSync(0);
...
{ // Length of buffer is in wchar_t units, excluding the NULL terminator.
    ...
    while (!done) {
        ...
        if (PadStatus & CancelButton) {
        ...
        } else if (PadStatus & PAD_START) { /* Highlight the "ENTER" key. */
            SelectedKeyX = 11;
            SelectedKeyY = 2;
            ...
            if (SelectedKeyboardKeyset >= NUM_KEYBOARD_KEYSETS)
                SelectedKeyboardKeyset = 0;
        } else if (PadStatus_raw != 0) {
            if (PadStatus_raw & SelectButton) {
                if (SelectedKeyX == 11 && SelectedKeyY == 2) { // ENTER button
                    result = 0;
                    done   = 1;
                ...
                if (CursorPosition > 0) { /* First move everything after the cursor back by one space. */
                    ...
                    if (CursorPosition > DisplayedCharCount) { // Scroll the start position instead.
                        if (CursorPositionOnScreen == 0) {
                            DisplayedCharStartPos = CursorPosition;
                        } else {
                        ...
                        if (CursorPositionOnScreen > 0)
                            CursorPositionOnScreen--;
                        if (CursorPositionOnScreen == 0) { // Scroll the start position instead.
                            DisplayedCharStartPos = CursorPosition;
                        }
                    }
                }
